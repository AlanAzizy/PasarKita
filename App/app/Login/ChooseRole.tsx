    ...
    return (
        <View style={styles.container}>
            <View style={{flex:4.5, borderWidth:0, borderColor:"#ff1111", width:"100%", justifyContent:"center", margin:5, padding:20}}>
                <Text style={{fontFamily:"Poppins-Regular", color:"#53845D", width:"80%", fontSize:28, fontWeight:"bold"}}>Choose your role!</Text>
            </View>
            <View style={{flex:7, borderWidth:0, borderColor:"#ff1111", width:"90%"}}>
                <Button  onPress={()=>{setRole("Market Owner")}}
                    title="Market Owner" styles={(role=="Market Owner")? styles.roleClick : styles.roleButton} isLight={false}
                    size={20}
                />
                <Button  onPress={()=>{setRole("Stall Owner")}}
                    title="Stall Owner" styles={(role=="Stall Owner")? styles.roleClick : styles.roleButton} isLight={false}
                    size={20}
                />
            </View>
            ...
            <View style={{flex:11, borderWidth:0, borderColor:"#ff1111", width:"100%"}}>
